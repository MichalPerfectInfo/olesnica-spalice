...
export const ImageModal: React.FC<ImageModalProps> = ({ apartment, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-xl shadow-2xl relative w-full max-w-4xl max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 p-4 md:p-6">
          <div className="relative flex items-center justify-center bg-gray-50 rounded-lg w-full">
            {isLoading && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 text-gray-500 z-10 min-h-[200px]">
            ...
            <img 
              ...
              className={`w-full h-auto object-contain transition-opacity duration-300 ease-in-out ${isLoading || imageError ? 'opacity-0' : 'opacity-100'}`}
