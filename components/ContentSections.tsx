...
export const StandardsSection: React.FC = () => (
  <section id="o-inwestycji" className="scroll-mt-20">
    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="order-2 lg:order-1">
           <img src="../assets/widok_02.jpg"  alt="Osiedle" className="rounded-2xl shadow-lg" />
        </div>
    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="order-2 lg:order-1">
           <img src="../assets/widok_4.jpg" alt="Ogród" className="rounded-2xl shadow-lg" />
        </div>
        <div className="order-1 lg:order-2">
          <div className="w-12 h-1 bg-primary-600 mb-6 rounded-full"></div>
